...
|----|----|
| PB-868 | On the **Application** page, you can now select the **Backup**  button to perform a new backup operation, even if PX-Backup still loads resources. |
