...
| PB-856 | If you logged in for the first time and no clusters were added to PX-Backup, the dashboard indicated that PX-Backup must still load the stats. </br></br> **User impact:** The stats section of the dashboard displayed three dots. </br></br> **Resolution:** The dashboard now shows that no clusters are added to PX-Backup, by setting all stats to zero. |
